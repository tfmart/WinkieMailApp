//
//  AgendadasTableViewController.swift
//  Winkie
//
...
class AgendadasTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        get_data_from_url("https://winkiemailapp.mybluemix.net/agendada")
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "mailAgendada" {
            if let emailPageDetail = segue.destination as? MailAgendadasViewController {
                ...
                emailPageDetail.nomeFoto = "ag\(mailIndex!)"
