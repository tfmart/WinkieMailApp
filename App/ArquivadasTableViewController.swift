//
//  ArquivadasTableViewController.swift
//  WinkieTestApp
//
...
class ArquivadasTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        get_data_from_url("https://jemail.mybluemix.net/Arquivadasget")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "arquivado", for: indexPath)
        
//        if let arquivadaCell = cell as? ArquivadasTableViewCell {
//            arquivadaCell.titleLabel.text = assunto[indexPath.row]
//        }
        //cell.textLabel?.text = assunto[indexPath.row]
        if let inboxCell = cell as? ArquivadasTableViewCell {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showArquivada" {
            if let emailPageDetail = segue.destination as? ArquivadaMailViewController {
                ...
                emailPageDetail.nomeFoto = "a\(mailIndex!)"
            }
        }
    }
